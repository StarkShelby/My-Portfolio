    ...
    <section className="py-20 w-full  ">
      ...
      <div className="py-20  flex-col lg:flex-row items-center justify-center  w-full gap-4 mx-auto px-8  md:flex">
        ...
        <Card
          ...
          description="In this final phase, I develop the product using clean, scalable code. I implement animations, test performance, ensure accessibility, and refine until everything feels just right. Then it's deployed — polished and production-ready."
        >
          <CanvasRevealEffect
            animationSpeed={3}
